...
pg.mixer.music.set_volume(0.89) #le volume est à 89%
...
for i in range(0,1): # 1 si le nombre de joueur est de 1
    try:
        ...
        sys.exit()
#       Obstacles
for i in range(0,3): # 3 si le nombre d'images d'osbtacle est de 3 
    try:       
...
while maintain:
    ...
    if generated==False: #Genere la position initiale des obstacles
        for i in range(0,5):
            ...
            offset_obstacle.append(rdm.randrange(scrolling-40,scrolling-1000,-40)) #Difficultés avec randrange, ne prend en charge que des ints
        generated=True
